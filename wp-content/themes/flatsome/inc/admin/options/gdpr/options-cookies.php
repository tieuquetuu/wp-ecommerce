...
Flatsome_Option::add_section( 'gdpr', array(
	'title'    => __( 'GDPR', 'flatsome-admin' ),
	'priority' => 160,
) );
	...
	$wp_customize->selective_refresh->add_partial( 'cookies-text', array(
		...
		'render_callback' => function () {
			return get_theme_mod( 'cookie_notice_text' )
				...
				: __( 'This site uses cookies to improve your browse experience. By browsing this website, you agree to our use of cookies.', 'flatsome' );
		},
	) );
}
